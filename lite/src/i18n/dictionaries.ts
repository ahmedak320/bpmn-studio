...
export const en = {
  ...
  'editor.langToggle': '🌐 EN⇄AR',
  'editor.langToggle.title': 'Switch the diagram labels between English and Arabic',
  'editor.langToggle.missing': 'No stored translations on this diagram yet — generate with AI, import from ARIS, or add names via Details.',
  ...
  'editor.translate.title': 'Fill in missing Arabic/English names with AI — stored inside the file when you save',
  'translate.noKey': 'No AI key configured — add one in Settings to translate.',
  'translate.nothing': 'Every label already has both languages.',
  'translate.running': 'Translating {count} labels…',
  'translate.done': 'Translated {count} labels. Save to keep them in the file.',
  'translate.partial': 'Translated {done} of {total} labels (the model skipped {skipped}). Run again to retry the rest.',
...
export const ar: Record<keyof typeof en, string> = {
  ...
  'editor.langToggle.missing': 'لا توجد ترجمات محفوظة في هذا المخطط بعد — ولّده بالذكاء الاصطناعي، أو استورده من ARIS، أو أضف الأسماء عبر التفاصيل.',
  ...
  'editor.translate.title': 'إكمال الأسماء العربية/الإنجليزية الناقصة بالذكاء الاصطناعي — تُحفظ داخل الملف عند الحفظ',
  'translate.noKey': 'لا يوجد مفتاح ذكاء اصطناعي — أضف واحدًا في الإعدادات للترجمة.',
  'translate.nothing': 'كل التسميات لديها اللغتان بالفعل.',
  'translate.running': 'جارٍ ترجمة {count} تسمية…',
  'translate.done': 'تمت ترجمة {count} تسمية. احفظ الملف للاحتفاظ بها.',
  'translate.partial': 'تمت ترجمة {done} من {total} تسمية (تخطى النموذج {skipped}). أعد المحاولة للبقية.',
