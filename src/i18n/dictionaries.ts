...
export const en = {
  ...
  'aris.explorer.aria': 'ARIS workspace explorer',
  ...
  'translationReview.runSummary':
    '{proposals} proposal(s) returned · {failed} item(s) failed and remain listed for retry or manual entry.',
  'translationReview.nothingSendable':
    'None of the {count} unresolved field(s) can be sent automatically — fix the source text or enter the value manually below.',
  'translationReview.acceptAll': 'Accept all proposals',
...
export const ar: Record<keyof typeof en, string> = {
  ...
  'aris.explorer.aria': 'مستكشف مساحة عمل ARIS',
  ...
  'translationReview.runSummary':
    'عاد {proposals} من المقترحات · فشل {failed} من العناصر وتبقى مدرجة لإعادة المحاولة أو الإدخال اليدوي.',
  'translationReview.nothingSendable':
    'لا يمكن إرسال أي من الحقول غير المحسومة ({count}) تلقائيًا — صحّح نص المصدر أو أدخل القيمة يدويًا أدناه.',
  'translationReview.acceptAll': 'اعتماد كل المقترحات',
  ...
  'aris.toolbar.printFrame': 'إطار الطباعة',
  'aris.toolbar.printFrame.title': 'إظهار أو إخفاء ترويسة الطباعة ووسيلة الإيضاح (عناصر الصفحة)',
  ...
  'aris.printFrame.processCode': 'رمز العملية',
  'aris.printFrame.processName': 'اسم العملية',
  'aris.printFrame.organizationalOwner': 'المسؤول التنظيمي',
  'aris.printFrame.headerAria': 'ترويسة الطباعة للنموذج {model}',
  'aris.printFrame.orgBlock': 'مربع بيانات الجهة — صورة OLE المستوردة لم تُفكَّك بعد',
  'aris.printFrame.legendAria': 'مفتاح رموز DMT ومصفوفة RACI',
  'aris.printFrame.raci.title': 'مصفوفة الصلاحيات للأدوار الوظيفية/ RACI',
  'aris.printFrame.raci.responsible': 'مسؤول عن التنفيذ',
  'aris.printFrame.raci.approval': 'الموافقة والاعتماد',
  'aris.printFrame.raci.consulted': 'يستشار عند التنفيذ',
  'aris.printFrame.raci.informed': 'يُعلم بالتنفيذ أو النتيجة',
  ...
  'aris.translate.autoRunning': 'جارٍ ترجمة {count} تسمية تلقائيًا…',
  'aris.translate.autoPartial':
    'تمت ترجمة {applied} تسمية تلقائيًا؛ تعذّرت ترجمة {remaining} — افتح «ترجمة…» للمراجعة.',
  'aris.translate.autoFailed': 'فشلت الترجمة التلقائية: {error}',
  ...
  'aris.rail.tab.tools': 'الأدوات',
  'aris.rail.tab.generate': '✨ إنشاء',
  'aris.rail.tabsAria': 'لوحات الأدوات والإنشاء والتفاصيل',
  'aris.type.blockName': 'عنصر {name}',
  'aris.details.general.objectType': 'نوع الكائن',
  'aris.modelType.eepc': 'عملية (EPC)',
  'aris.modelType.vacd': 'مخطط سلسلة القيمة المضافة',
  'aris.contextMenu.aria': 'إجراءات العنصر',
  'aris.contextMenu.changeType': 'تغيير نوع الكائن…',
  'aris.changeType.title': 'تغيير نوع الكائن',
  'aris.changeType.current': 'الحالي: {name}',
  'aris.changeType.keepData': 'تُحتفَظ بالوصلات والسمات والأسماء، ويُعاد تشغيل التحقق بعد التغيير.',
  'aris.changeType.failed': 'رُفض تغيير النوع: {error}',
